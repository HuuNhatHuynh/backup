...
for _ in tqdm(range(mc)):
    ...
    for name, array in array_dict.items():
        ...
        estimated_phi_fft, estimated_theta_fft = array.estimate_doa_spatial_fft_autofocusing(Rx, freqs, nbSources, sizeVerticalFFT, sizeHorizontalFFT)
        ...
        estimated_phi_music, estimated_theta_music = array.estimate_doa_music_autofocusing(Rx, freqs, nbSources)
...
with open("results_autofocusing/results_{}_db.json".format(snr), "w") as f:
