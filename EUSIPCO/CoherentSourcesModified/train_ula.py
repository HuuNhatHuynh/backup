...
for i in range(nbTrain):
    ...
    observations, angles = generate_data(n, t, d, snr, snr, array, True)
    ...
    train(da_music, nbEpoches, lr, wd, 
          ...
          path+'da_music_'+str(snr)+'dB_'+str(i)+'.pth', 
...
for i in range(nbTrain):
    ...
    train(da_music_v2, nbEpoches, lr, wd, 
          train_loader, valid_loader, 
          path+'da_music_v2_'+str(snr)+'dB_'+str(i)+'.pth', 
          train_func, valid_func)
...
for i in range(nbTrain):
    ...
    train(rnn, nbEpoches, lr, wd, train_loader, valid_loader, 
          path+'rnn_'+str(snr)+'dB_'+str(i)+'.pth', 
          train_func, valid_func)